namespace BeachCanvas08_2 {
    ...
    */
    ...
    function drawSunlight(_position: Vector): void {
    ...
    function drawPalms(_position: Vector): void {
        let nPlams: number = 42;
        for (let i: number = 0; i < nPlams; i++) {
            let x: number = Math.random() * _position.x;
            let y: number = (Math.random() * _position.y) + horizon;
            //Stamm
            crc2.save();
            crc2.translate(x, y);
            crc2.beginPath();
    ...
    function drawTowels(_position: Vector, _color: string): void {
        crc2.save();
        crc2.translate(_position.x, _position.y);
    ...
    function drawPerson(_position: Vector, _rotation: number): void {
        crc2.save();
        crc2.translate(_position.x, _position.y);
