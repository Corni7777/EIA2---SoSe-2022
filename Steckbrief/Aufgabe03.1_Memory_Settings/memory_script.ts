 namespace L03_1_memory {
    ...
    function dealCards(): void {
        ...
        for (let i: number = 0; i < allCards.length; i++) {
            ...
            card.style.height = cardsizeNumber * 1.5 + "px";
    ...
    function turnFirstCard(_event: Event): void {
        this.style.fontSize = cardsizeNumber * 0.8 + "px";
    ...
    function turnSecondCard(_event: Event): void {
        ...
        setTimeout(function (): void {
            ...
            if (turnedCards[0] == turnedCards[1]) {
                ...
                setTimeout(function (): void { victoryScreen(); }, 500);
            }
            else {
    ...
    function victoryScreen(): void {
        if (wrapper.getElementsByClassName("card").length == wrapper.getElementsByClassName("hidden").length) {
            document.body.removeChild(displaytimer);
            alert("Good Job! You have discoverd all pairs! Your time was " + minutes + " minutes and " + seconds + " seconds.");
            location.reload();
        }
